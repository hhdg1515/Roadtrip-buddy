...
const destinationSeeds: DestinationSeed[] = [
  {
    ...
    avoid: [
      "Assuming full Highway 1 is frictionless",
      "Remote trailhead-heavy days",
      "Last-minute Carmel dinner plans",
    ],
    suggestedStops: [
      "Carmel-by-the-Sea",
      "Point Lobos",
    ...
    planB: {
      trigger: "Highway 1 feels risky",
      alternative: "Carmel, Point Lobos, Monterey, 17-Mile Drive",
      whyItWorks: "Same coast mood, easier routing",
      timeDifference: "About 60-90 minutes less driving across the trip.",
    },
    itinerary: [
      {
        day: "Day 1",
        morning: "Roadtrip to Carmel through Monterey",
        midday: "Lunch in Carmel",
        afternoon: "Point Lobos or Garrapata stops",
        evening: "Carmel dinner + sunset",
        note: "This first day keeps the group fresh instead of burning everything on the drive.",
      },
      {
        day: "Day 2",
        morning: "Scenic Big Sur drive south",
        midday: "Lunch around Big Sur",
        afternoon: "Pfeiffer Big Sur or redwood stop",
        evening: "Dinner back in Carmel",
        note: "The plan uses the car as part of the experience rather than a burden.",
      },
      {
        day: "Day 3",
        morning: "Slow breakfast + final coast stop",
        midday: "Monterey aquarium or cafe loop",
        afternoon: "Northbound drive with food stop",
  ...
  },
  {
    ...
    avoid: [
      "Making Tioga or high country the plan",
      "Overcommitting to major hikes",
      "Late arrivals that lose parking",
    ],
    suggestedStops: [
      "Tunnel View",
      "Lower Yosemite Fall",
    ...
    planB: {
      trigger: "Higher trails feel snowy or crowded",
      alternative: "Valley floor, waterfalls, Mariposa Grove",
      whyItWorks: "Best spring scenery stays low",
      timeDifference: "About 2-3 hours less hiking and transition time.",
    },
    itinerary: [
      {
        day: "Day 1",
        morning: "Early Yosemite drive-in",
        midday: "Valley check-in + Lower Yosemite Fall",
        afternoon: "Tunnel View + valley loop",
        evening: "Dinner near base",
        note: "Use the first day to understand conditions instead of chasing too much.",
      },
      {
        day: "Day 2",
        morning: "Primary valley hike",
        midday: "Easy valley lunch",
        afternoon: "Photography run or grove stop",
        evening: "Viewpoint before dinner",
        note: "This is the main payoff day, but the trip still works if you shorten the hike.",
      },
      {
        day: "Day 3",
        morning: "Final waterfall or grove stop",
        midday: "Brunch before exit",
        afternoon: "Drive home",
        evening: "Home from Yosemite",
  ...
  },
  {
    ...
    avoid: [
      "Treating it like a pure hiking trip",
      "Assuming every activity is in season",
    ...
    planB: {
      trigger: "Mountain weather turns mixed",
      alternative: "Shoreline stops, town time, Emerald Bay",
      whyItWorks: "Less gear, easier day",
      timeDifference: "About 2 hours less gear and transition overhead.",
    },
    itinerary: [
      {
        day: "Day 1",
        morning: "Drive to Tahoe with one stop",
        midday: "Conditions check + lunch",
        afternoon: "Lakefront stop + town setup",
        evening: "Early dinner near base",
        note: "Use day one to pick the version of Tahoe the weekend really supports.",
      },
      {
        day: "Day 2",
        morning: "Snow or alpine block",
        midday: "Recovery lunch",
        afternoon: "Emerald Bay or shoreline drive",
        evening: "Dinner + sunset stop",
        note: "Tahoe performs best when the split plan is explicit.",
      },
      {
        day: "Day 3",
        morning: "Final lakeside stop",
        midday: "Truckee or town lunch",
        afternoon: "Drive home before traffic",
        evening: "Home",
  ...
  },
  {
    ...
    avoid: [
      "Pretending it is already summer",
      "Using Mammoth as the easy compromise",
    ...
    planB: {
      trigger: "Snow window softens",
      alternative: "Hot springs, scenic drives, Mammoth town",
      whyItWorks: "Still feels like Eastern Sierra",
      timeDifference: "About 1-2 hours less mountain transition time.",
    },
    itinerary: [
      {
        day: "Day 1",
        morning: "Drive to Mammoth",
        midday: "Town check-in + light outing",
        afternoon: "Village loop or scenic drive",
        evening: "Early dinner + reset",
        note: "Respect the drive or the rest of the trip loses quality.",
      },
      {
        day: "Day 2",
        morning: "Main snow block",
        midday: "Lunch near base",
        afternoon: "Hot springs or scenic loop",
        evening: "Dinner in town",
        note: "This is a snow-first plan with backup structure.",
      },
      {
        day: "Day 3",
        morning: "Short mountain closeout",
        midday: "Start the return drive",
        afternoon: "Drive home",
        evening: "Home",
  ...
  },
  {
    ...
    avoid: [
      ...
      "Treating April like winter",
      "Using this as an easy Bay Area weekend",
    ],
    suggestedStops: [
    ...
    planB: {
      trigger: "Afternoon heat spikes",
      alternative: "Sunrise stops, scenic drives, lodge downtime",
      whyItWorks: "Better timing, less heat exposure",
      timeDifference: "Roughly 2-3 fewer daytime activity hours.",
    },
    itinerary: [
      {
        day: "Day 1",
        morning: "Long desert drive-in",
        midday: "Park entry + low-key arrival",
        afternoon: "One scenic stop if temps allow",
        evening: "Sunset dinner + reset",
        note: "Arrival energy management is part of safety here.",
      },
      {
        day: "Day 2",
        morning: "Main scenic loop before heat",
        midday: "Hydration break + retreat",
        afternoon: "Short exposed stops only",
        evening: "Stargazing closeout",
        note: "The plan works only when the clock controls the trip.",
      },
      {
        day: "Day 3",
        morning: "Final dawn stop",
        midday: "Exit before peak heat",
  ...
  },
  {
    ...
    avoid: [
      "Exposed trails all day in wind",
      "Only one West Marin food plan",
      "Lighthouse timing without parking checks",
    ],
    suggestedStops: [
      "Point Reyes Station",
      "Bear Valley area",
    ...
    planB: buildPlanB(
      "Wind, fog, or parking gets rough",
      "Limantour, Tomales Bay, Point Reyes Station",
      "Same coast feel, less exposure",
      "Usually 45-75 minutes less driving across the trip.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Early drive to Point Reyes",
        "Lunch in Point Reyes Station",
        "One exposed viewpoint block",
        "Dinner in town or Tomales Bay",
      ...
      buildItineraryDay(
        ...
        "Main coast walk",
        "Lunch back in town",
        "Beach stop or scenic drive",
        "West Marin dinner",
        "This destination gets better when you protect the relaxed tempo.",
      ),
      buildItineraryDay(
        "Day 3",
        "Coffee + final shoreline stop",
        "Oyster or bakery stop",
        "Drive home",
        "Home with energy left",
  ...
  },
  {
    ...
    avoid: [
      "Long exposed viewpoint hangs in wind",
      "Cold-water beach plans without backup",
      "No dinner backup",
    ],
    suggestedStops: [
      "Bodega Bay",
    ...
    planB: buildPlanB(
      "The coast feels too windy",
      "Jenner, Freestone, Occidental",
      "Same scenery, less wind",
      "About 30-60 minutes less exposed driving and standing around.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Northbound drive with food stop",
        "Check-in near Bodega Bay",
        "Easy bluff or harbor stop",
        "Seafood dinner or inland fallback",
        "This place works because the logistics stay forgiving.",
      ),
      buildItineraryDay(
        "Day 2",
        "Morning viewpoint block",
        "Lunch near town",
        "Jenner, Goat Rock, or bakery town",
        "Flexible sunset stop",
        "The best version of this trip is scenic but not overpacked.",
      ),
      buildItineraryDay(
        "Day 3",
        "Final shoreline or cafe stop",
        "Easy coastal exit",
        "Drive home with snack stop",
        "Home restored",
  ...
  },
  {
    ...
    avoid: [
      "Building around high-country access",
      "Trying to cover both parks fully",
      "Treating park transfers as small add-ons",
    ],
    suggestedStops: [
      "Giant Forest",
      "Congress Trail",
    ...
    planB: buildPlanB(
      "Kings Canyon side feels too ambitious",
      "Giant Forest, Moro Rock, foothills",
      "Core tree stops still carry the trip",
      "Usually 1-2 hours less driving across the trip.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Arrival through Three Rivers",
        "Gateway lunch + elevation reset",
        "Grove or overlook stop",
        "Dinner near base",
        "This trip rewards steady pacing more than a huge first day.",
      ),
      buildItineraryDay(
        "Day 2",
        "Giant-tree morning block",
        "Lunch + icon reset",
        "Moro Rock or forest walk",
        "Return to base",
        "The best version is memorable but still disciplined.",
      ),
      buildItineraryDay(
        "Day 3",
        "Final grove or foothill stop",
        "Early park exit",
        "Drive home with food stop",
  ...
  },
  {
    ...
    avoid: [
      "Assuming high trails are summer-clean",
      "Late arrival on peak weekends",
    ...
    planB: buildPlanB(
      "Higher trails are icy or windy",
      "Lakefront loops, village, scenic drive",
      "Still works without big trail mileage",
    ...
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Arrive in Big Bear",
        "Lunch near the village",
        "Lakefront stop or easy loop",
        "Town dinner + relaxed evening",
  ...
  },
  {
    ...
    avoid: [
      "Using city weather as mountain weather",
      "Assuming every road and trail is open",
      "Overbuilding a short-flex trip",
    ],
    suggestedStops: [
    ...
    planB: buildPlanB(
      "Crest roads feel fragile",
      "Lower overlooks, short hike, Wrightwood",
      "Mountain contrast, less road risk",
      "Usually 1 hour less mountain driving.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Early climb out of LA",
        "Lunch near foothills or Wrightwood",
        "One focused scenic corridor",
        "Dinner near base",
        "The best version is focused, not sprawling.",
      ),
      buildItineraryDay(
        "Day 2",
        "Main hike or overlook block",
        "Lunch near town",
        "Short second scenic block",
        "Simple evening",
        "A light touch usually beats an overbuilt alpine schedule here.",
      ),
      buildItineraryDay(
        "Day 3",
        "Coffee + final pull-off",
        "Descend before traffic",
        "City return + meal stop",
        "Home reset",
  ...
  },
  {
    ...
    avoid: [
      "Basing the trip on fragile high access",
      "Expecting dense dining or nightlife",
      "Treating remote lake roads as summer-ready",
    ],
    suggestedStops: [
      "Shaver Lake village",
    ...
    planB: buildPlanB(
      "Upper lake roads feel uncertain",
      "Shaver, lower trails, cabin time",
      "Same forest calm, less driving",
      "Usually 1-2 hours less driving and less uncertainty.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Drive in with supplies handled",
        "Check-in near Shaver",
        "Shoreline time near base",
        "Simple dinner + early night",
        "The whole point is to reach mountain calm quickly.",
      ),
      buildItineraryDay(
        "Day 2",
        "Main hike or creek block",
        "Lunch back near base",
        "Huntington or scenic drive",
        "Cabin evening or village dinner",
        "This destination pays off when you protect the relaxed cabin rhythm.",
      ),
      buildItineraryDay(
        "Day 3",
        "Slow breakfast + final pine stop",
        "Pack up + easy exit",
        "Drive home with food stop",
        "Home reset",
  ...
  },
  {
    ...
    avoid: [
      "Assuming summer-clean alpine access",
      "Skipping service planning",
      "Too many remote segments in one day",
    ],
    suggestedStops: [
      "Mount Shasta town",
      "McCloud Falls",
    ...
    planB: buildPlanB(
      "Alpine roads feel fragile",
      "McCloud Falls, Siskiyou Lake, town",
      "Big-mountain feel, less exposure",
      "Usually 1-2 hours less driving and condition uncertainty.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Arrive in Mount Shasta",
        "Town reset + short check-in",
        "Easy viewpoint or lake stop",
        "Dinner in town",
      ...
      buildItineraryDay(
        ...
        "Main waterfall run",
        "Lunch + route reset",
        "Second scenic drive or town stop",
        "Slow evening with mountain views",
        "This trip rewards clean choices more than maximum mileage.",
      ),
      buildItineraryDay(
        "Day 3",
        "Coffee + final easy stop",
        "Start the return early",
        "Efficient road day",
        "Home before late fatigue",
  ...
  },
  {
    ...
    avoid: [
      "Summer-style Lassen coverage",
      "Assuming roads and boardwalks are open",
      "No lower-elevation backup",
    ],
    suggestedStops: [
    ...
    planB: buildPlanB(
      "The park stays too snowbound",
      "Lower stops, lake, forest block",
      "North-state trip still pays off",
      "Varies, but often 1-2 fewer hours inside the park itself.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Arrival day + one scenic block",
        "Road status check",
        "One easy accessible area",
        "Early dinner + stop",
        "This place punishes optimistic assumptions in spring.",
      ),
      buildItineraryDay(
        "Day 2",
        "Main accessible scenic zone",
        "Lunch near base",
        "Lower-elevation scenic block",
        "Early reset",
        "Shoulder-season Lassen is about selective wins, not total coverage.",
      ),
      buildItineraryDay(
        "Day 3",
        "Final easy viewpoint",
        "Begin the return",
        "Exit-route meal stop",
        "Efficient road day",
  ...
  },
  {
    ...
    avoid: [
      "Letting the far-north drive take over",
      "Too many grove swaps in one day",
      "Expecting warm beach time",
    ],
    suggestedStops: [
    ...
    planB: buildPlanB(
      "Weather turns cold or wet",
      "Short groves, coastal pull-offs, Arcata",
      "Easy scenery close to the car",
      "Usually 1-2 fewer outdoor hours, but the trip remains viable.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Long northbound drive-in",
        "Settle near Trinidad or Arcata",
        "Short redwood or bluff block",
        "Early dinner + reset",
      ...
      buildItineraryDay(
        "Day 2",
        "Main grove day",
        "Lunch back toward town",
        "Second forest block or coast overlook",
        "Slow dinner + hang time",
        "This place feels richest when you let the forest absorb the tempo.",
      ),
      buildItineraryDay(
        "Day 3",
        "Final grove or harbor stop",
        "Start the return early",
        "Efficient road day",
        "Home with the trip intact",
  ...
  },
  {
    ...
    avoid: [
      "Expecting polished tourism services",
      "Skipping forest-road backup research",
      "Packing too much mileage",
    ],
    suggestedStops: [
      "Etna",
    ...
    planB: buildPlanB(
      "Forest roads feel uncertain",
      "Scott Valley, river views, Etna",
      "Remote feel, less backroad risk",
      "Usually 1-2 fewer hours of backroad driving.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "North-state drive-in",
        "Check-in + local conditions read",
        "One valley or town block",
        "Simple dinner + rest",
        "This trip rewards patience more than ambition.",
      ),
      buildItineraryDay(
        "Day 2",
        "Main forest or river block",
        "Lunch + route reset",
        "Short scenic leg",
        "Quiet evening",
      ...
      buildItineraryDay(
        "Day 3",
        "Final river or valley stop",
        "Start the exit",
        "Highway-town meal stop",
        "Efficient drive home",
  ...
  },
  {
    ...
    avoid: [
      "Treating the ferry like an add-on",
      "Assuming food or shelter on-island",
      "Ignoring wind or sea forecast",
    ],
    suggestedStops: [
      "Ventura Harbor",
    ...
    planB: buildPlanB(
      "Ferry or wind looks shaky",
      "Ventura coast, harbor, shoreline loop",
      "Same coast weekend, less logistics",
    ...
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Reach Ventura early",
        "Ferry logistics + harbor lunch",
        "Harbor or mainland coast block",
        "Early dinner + sleep",
      ...
      buildItineraryDay(
        "Day 2",
        "Island day",
        "Food, water, and turnaround reset",
        "Return ferry + harbor pacing",
        "Harbor dinner",
        "The point is one memorable outdoor day, not endless add-ons.",
      ),
      buildItineraryDay(
        "Day 3",
        "Gentle coast or breakfast stop",
        "Leave Ventura cleanly",
        "Drive home or next city stop",
        "Simple finish",
  ...
  },
  {
    ...
    avoid: [
      "Expecting Cabrillo crowds to self-resolve",
      "All-day exposed coast time in wind",
      "Overcomplicating an easy trip",
    ],
    suggestedStops: [
    ...
    planB: buildPlanB(
      "Cabrillo gets windy or crowded",
      "Harbor walks, Liberty Station, Sunset Cliffs",
      "Easy coastal backup in the city",
    ...
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Arrive in San Diego",
        "Lunch near Point Loma",
        "Harbor or cliffside scenery",
        "Dinner nearby",
        "This place is strongest when it stays unforced.",
      ),
      buildItineraryDay(
        "Day 2",
        "Cabrillo morning block",
        "Lunch close by",
        "Short trail or coastal reset",
        "Sunset stop if wind allows",
        "The trip should feel easy almost the whole time.",
      ),
      buildItineraryDay(
        "Day 3",
        "Breakfast + final viewpoint",
        "Begin the exit",
        "Simple travel block",
        "Home or next stop",
  ...
  },
  {
    ...
    avoid: [
      "Midday exposed hiking",
      "Treating April like winter",
      "Relying on in-park town support",
    ],
    suggestedStops: [
      "Hidden Valley",
      "Barker Dam",
    ...
    planB: buildPlanB(
      "Heat rises fast",
      "Sunrise walks, scenic drives, town breaks",
      "Best desert light is early and late",
    ...
    itinerary: [
      buildItineraryDay(
        ...
        "Check-in + simple logistics",
        "Easy walk or viewpoint",
        "Dinner in town",
        "Desert pacing should start conservative.",
      ),
      buildItineraryDay(
        "Day 2",
        "Main hike + photo block",
        "Lunch + rest outside the park",
        "Short scenic stops only",
        "Sunset view + easy dinner",
        "The clock should control the trip, not ambition.",
      ),
      buildItineraryDay(
        "Day 3",
        "Final dawn or breakfast block",
        "Exit before peak warmth",
        "Drive home with one stop",
  ...
  },
  {
    ...
    avoid: [
      "Using midday as the main window",
      "Expecting dense backup services",
      "Casual wash or rough-road driving",
    ],
    suggestedStops: [
      "Borrego Springs",
    ...
    planB: buildPlanB(
      "Heat or wind rises fast",
      "Sunrise blocks, town reset, sunset drive",
      "Comfort holds if midday stays light",
      "Usually 2-3 fewer exposed outdoor hours.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Arrive for a sunset drive",
        "Check-in + heat reset",
        "One scenic block",
        "Dinner in Borrego Springs",
        "The desert asks for discipline from the first day.",
      ),
      buildItineraryDay(
        "Day 2",
        "Dawn-centered desert block",
        "Town break before heat",
        "Short scenic stop if conditions hold",
        "Low-key sunset closeout",
        "This destination works best in short, well-timed bursts.",
      ),
      buildItineraryDay(
        "Day 3",
        "Final dawn or breakfast stop",
        "Start the return early",
        "Simple road day",
        "Home with energy left",
  ...
  },
  {
    ...
    avoid: [
      "Treating Mono as a full weekend alone",
      "Skipping Lee Vining food",
      "Wading in the lake casually",
    ],
    suggestedStops: [
      "South Tufa",
    ...
    planB: buildPlanB(
      "Wind or dust hits the shoreline",
      "June Lake Loop, Mammoth, town time",
      "395 still carries the trip",
      "About an hour of transit moved from lake time into town time.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "395 drive with scenic pull-offs",
        "Lunch in Lee Vining",
        "South Tufa golden hour",
        "Dinner + early sleep",
        "Day one is mostly the drive — respect that.",
      ),
      buildItineraryDay(
        "Day 2",
        "Panum Crater morning walk",
        "June Lake Loop + lunch",
        "Second tufa stop or boardwalk",
        "Sunset back at the lake",
        "This is the payoff day. Keep it unhurried.",
      ),
      buildItineraryDay(
        "Day 3",
        "Sunrise stop if energy allows",
        "Coffee in Lee Vining",
        "Mammoth lunch or hot springs stop",
        "Home from the Eastern Sierra",
  ...
  },
  {
    ...
    avoid: [
      "Whitney summit without permit or experience",
      "Assuming cell service at pull-offs",
      "Treating Lone Pine as a food town",
    ],
    suggestedStops: [
      "Mobius Arch loop",
      "Movie Road",
    ...
    planB: buildPlanB(
      "Portal Road closes or gets windy",
      "Alabama Hills, Manzanar, Bishop",
      "Strong scenery without portal access",
      "Drops about 1-2 hours of elevation driving, adds equivalent low-desert scenic time.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "395 drive with Manzanar stop",
        "Check-in + lunch in Lone Pine",
        "Alabama Hills golden hour",
      ...
      buildItineraryDay(
        ...
        "Whitney Portal Road drive",
        "Lone Pine Lake hike or Portal walk",
        "Town return + sunset pass",
        "This is the main day. The elevation transitions are the story.",
      ),
      buildItineraryDay(
        "Day 3",
        "Coffee + final scenic stop",
        "Bishop lunch or southbound exit",
        "Scenic 395 return",
        "Home from the Eastern Sierra",
  ...
  },
  {
    ...
    avoid: [
      ...
      "Taking Highway 1 the whole way north",
      "Skipping Van Damme or Russian Gulch",
    ],
    suggestedStops: [
    ...
    planB: buildPlanB(
      "Fog or wind locks in",
      "Anderson Valley, Hendy Woods, Boonville",
      "Easy inland pivot with great stops",
      "Trades 1-2 coast hours for equivalent valley-and-redwood time.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Bay Area to Mendocino via 128",
        "Lunch in Boonville or Philo",
      ...
      buildItineraryDay(
        "Day 2",
        "Breakfast + Russian Gulch walk",
        "Fort Bragg lunch + Glass Beach",
        "Bookstore or wine bar time",
        "Point Cabrillo sunset + dinner",
        "This is the full-coverage day — headlands, redwoods, food.",
      ),
      buildItineraryDay(
        "Day 3",
        "Slow village morning",
        "Drive south via 128",
        "Anderson Valley stop if desired",
        "Home by dinner",
  ...
  },
  {
    ...
    avoid: [
      "Expecting Big Sur-scale drama",
      "Skipping Cayucos",
      "Same-day Hearst Castle booking",
    ],
    suggestedStops: [
      "Morro Rock",
    ...
    planB: buildPlanB(
      "Wind or fog kills the coast",
      "Paso Robles",
      "Easy pivot, no extra drive",
    ...
    itinerary: [
      buildItineraryDay(
        ...
        "Harbor walk + Cayucos",
        "Dinner in Morro Bay or Cayucos",
        "Day 1 is intentionally short — the drive is easier than Big Sur's, use the saved time.",
      ),
      buildItineraryDay(
        "Day 2",
        "Hearst Castle morning tour",
        "Elephant seals on the return",
        "Montana de Oro bluff trail",
        "Cayucos sunset + dinner",
        "This is the coverage day — castle, colony, cliffs, food.",
      ),
      buildItineraryDay(
        "Day 3",
        "Slow morning + coffee",
        "Paso Robles or Montana de Oro",
        "Home via 101",
        "Home without the drag",
  ...
  },
  {
    ...
    avoid: [
      "Treating it like Joshua Tree",
      "Lava Tube road in a low-clearance car",
      "Warm-season trips without heat planning",
    ],
    suggestedStops: [
      "Kelso Dunes",
    ...
    planB: buildPlanB(
      "Heat or dune wind hits early",
      "Hole-in-the-Wall, Mid Hills, Joshua Tree",
      "Higher ground stays friendlier",
      "Usually 10-15°F difference between Kelso Valley and Mid Hills.",
    ),
    itinerary: [
      buildItineraryDay(
        "Day 1",
        "Arrive via Baker with full tank",
        "Kelso Depot orientation",
        "Cima Dome drive at golden hour",
        "Camp or motel reset",
      ...
      buildItineraryDay(
        "Day 2",
        "Kelso Dunes at dawn",
        "Depot rest + hydration",
        "Hole-in-the-Wall trail",
        "Stargazing or Baker dinner",
